...
# code borrowed from transformers library # noqa
def eager_forward(
    self,
...
def fa2_forward(
    ...
    if isinstance(past_key_value, StaticCache):
        raise ValueError(
            ...
            'make sure to use `sdpa` in the mean time, and open an issue at transformers repository'
        )
